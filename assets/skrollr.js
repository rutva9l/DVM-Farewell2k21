...
autoscroll = () => {
  ...
  y > 5165 && y < 5330
    ? $(window).scrollTop(y + 960)
    : $(window).scrollTop(y + 870);
}; */
...
if (scrollTop + clientHeight >= scrollHeight-300) {
  ...
  /* container.removeChild(container.childNodes[8-i]); */
  /* container.appendChild(document.querySelector(`#profile${i}`));
  counter++;
  container.setAttribute("data-7000", `transform:translateX(-${i * 800}%)`); */
...
const profile6 = document.querySelector("#profile1");
const profile1 = document.querySelector("#profile1");
const profile1 = document.querySelector("#profile1"); */
